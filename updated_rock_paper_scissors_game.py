...
def recognize_gesture(hand_landmarks):
    """
    Recognize rock, paper, or scissors based on finger states:
    ...
    # Determine if thumb is up (extended to the side). Since the frame is flipped, 
    # thumb tip x > thumb ip x indicates extension.
    ...
    # Determine if other fingers are up (tip above pip in y-axis).
    ...
    # Check gestures
    if finger_up['index'] and finger_up['middle'] and  finger_up['ring'] and  finger_up['pinky'] and  finger_up['thumb']:  # All fingers are extended -> Paper
        return "paper"
    if not finger_up['index'] and not finger_up['middle'] and not finger_up['ring'] and not finger_up['pinky'] and not finger_up['thumb']:  # All fingers are closed -> Rock
        return "rock"
    if finger_up['index'] and finger_up['middle'] and not finger_up['ring'] and not finger_up['pinky'] and not finger_up['thumb']:  # Index and middle extended -> Scissors
        return "scissors"
    return None
